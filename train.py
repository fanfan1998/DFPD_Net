...
def train(config, model_name='resnet50'):
    ...
    S1_D1 = Discriminator(channels=256, num_classes=5, alpha=10, max_iter=max_iteration).to(device)
    S2_D1 = Discriminator(channels=256, num_classes=5, alpha=10, max_iter=max_iteration).to(device)
    S3_D1 = Discriminator(channels=256, num_classes=5, alpha=10, max_iter=max_iteration).to(device)

    S1_D2 = Discriminator(channels=256, num_classes=4, alpha=10, max_iter=max_iteration).to(device)
    S2_D2 = Discriminator(channels=256, num_classes=4, alpha=10, max_iter=max_iteration).to(device)
    S3_D2 = Discriminator(channels=256, num_classes=4, alpha=10, max_iter=max_iteration).to(device)
